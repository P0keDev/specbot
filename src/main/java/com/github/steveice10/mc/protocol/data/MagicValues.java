...
public class MagicValues {
    ...
    static {
        ...
        register(GenericStatistic.TAKING_INVENTORY, "achievement.openInventory");
        register(GenericStatistic.GETTING_WOOD, "achievement.mineWood");
        register(GenericStatistic.BENCHMARKING, "achievement.buildWorkBench");
        register(GenericStatistic.TIME_TO_MINE, "achievement.buildPickaxe");
        register(GenericStatistic.HOT_TOPIC, "achievement.buildFurnace");
        register(GenericStatistic.ACQUIRE_HARDWARE, "achievement.acquireIron");
        register(GenericStatistic.TIME_TO_FARM, "achievement.buildHoe");
        register(GenericStatistic.BAKE_BREAD, "achievement.makeBread");
        register(GenericStatistic.THE_LIE, "achievement.bakeCake");
        register(GenericStatistic.GETTING_AN_UPGRADE, "achievement.buildBetterPickaxe");
        register(GenericStatistic.DELICIOUS_FISH, "achievement.cookFish");
        register(GenericStatistic.ON_A_RAIL, "achievement.onARail");
        register(GenericStatistic.TIME_TO_STRIKE, "achievement.buildSword");
        register(GenericStatistic.MONSTER_HUNTER, "achievement.killEnemy");
        register(GenericStatistic.COW_TIPPER, "achievement.killCow");
        register(GenericStatistic.WHEN_PIGS_FLY, "achievement.flyPig");
        register(GenericStatistic.SNIPER_DUEL, "achievement.snipeSkeleton");
        register(GenericStatistic.DIAMONDS, "achievement.diamonds");
        register(GenericStatistic.WE_NEED_TO_GO_DEEPER, "achievement.portal");
        register(GenericStatistic.RETURN_TO_SENDER, "achievement.ghast");
        register(GenericStatistic.INTO_FIRE, "achievement.blazeRod");
        register(GenericStatistic.LOCAL_BREWERY, "achievement.potion");
        register(GenericStatistic.THE_END_1, "achievement.theEnd");
        register(GenericStatistic.THE_END_2, "achievement.theEnd2");
        register(GenericStatistic.ENCHANTER, "achievement.enchantments");
        register(GenericStatistic.OVERKILL, "achievement.overkill");
        register(GenericStatistic.LIBRARIAN, "achievement.bookcase");
        register(GenericStatistic.ADVENTURING_TIME, "achievement.exploreAllBiomes");
        register(GenericStatistic.THE_BEGINNING_1, "achievement.spawnWither");
        register(GenericStatistic.THE_BEGINNING_2, "achievement.killWither");
        register(GenericStatistic.BEACONATOR, "achievement.fullBeacon");
        register(GenericStatistic.REPOPULATION, "achievement.breedCow");
        register(GenericStatistic.DIAMONDS_TO_YOU, "achievement.diamondsToYou");
        register(GenericStatistic.OVERPOWERED, "achievement.overpowered");
